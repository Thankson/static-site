...
const actions = {
    ...
    async getData({ commit, dispatch }, info) {
        if(!state.isApiCalled) {
            ...
            return Promise.all([localizationFetch, lTEFetch])
                .then(() => {
                    // Both done
                    /* eslint-disable */console.log(...oo_oo(`3144329244_105_20_105_59_4`,'|-LTE: Done all fetchs-|'));
    ...
    async getDataError({ commit }) {
        ...
        if(response.success && !response?.data?.Success) {
            /* eslint-disable */console.log(...oo_oo(`3144329244_119_12_119_52_4`,'||-Force-Error-PL-Only-||'));
            commit('UPDATE_LOADED');
            commit('SET_FAIL_REQUEST');
        }
    },
