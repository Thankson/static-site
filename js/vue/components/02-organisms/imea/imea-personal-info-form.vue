<template>
    ...
    >
        <div class="flex flex-col md:flex-row justify-between">
            <div class="flex md:w-1_2 py-10">
                <!-- First Name -->
                <div v-if="labels.FirstName" class="flex-1 md:mr-15">
                    <label
                ...
                <!-- Initial -->
                <div v-if="labels.Initial && !isEurope" class="flex-1 ml-10 md:mx-15">
                    <label
                        class="uppercase font-medium text-sm"
                        :for="`${formId}-initial`"
...
<script>
    ...
    import imeaPersonalInfoFormMixin from '../../../mixins/imea-personal-info-form';
    ...
    export default {
        name: 'OImeaPersonalInfoForm',
        components: {
            BirthDateSelector,
            FormFieldErrorMessage,
            vInput
        },
        mixins: [imeaPersonalInfoFormMixin],
        created() {
