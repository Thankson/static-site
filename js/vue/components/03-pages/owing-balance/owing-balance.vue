    ...
    export default {
        ...
        methods: {
            ...
            getPaypalDeviceData() {
                window.braintree?.client?.create(
                    ...
                    (clientErr, clientInstance) => {
                        if(clientErr) {
                            /* eslint-disable */console.error(...oo_tx(`2828850302_524_28_524_79_11`,'Error creating client: ', clientErr));
                            return;
                        }
                        ...
                        window.braintree?.dataCollector?.create({
                            ...
                            if(dataCollectorErr) {
                                /* eslint-disable */console.error(...oo_tx(`2828850302_533_32_533_97_11`,'Error creating data collector:', dataCollectorErr));
                                return;
                            }
            ...
            async onPaymentSaved(prop) {
                ...
                /* eslint-disable */console.log(...oo_oo(`2828850302_545_16_545_86_4`,'pay method saved - after refresh', this.storedPayMethods));
                /* eslint-disable */console.log(...oo_oo(`2828850302_546_16_546_85_4`,'selected checkout pay method', this.selectedPayMethodId));
                ...
                if(payMethodId) {
                    ...
                    if(type && (this.cybersource || this.worldPay) && this.payOptions.some(card => card.Name === type)) {
                        ...
                        try {
                            ...
                            /* eslint-disable */console.error(...oo_tx(`2828850302_714_28_714_97_11`,'Error getting OTP token inside updatePayment:', error));
                        }
                    }
                }
            },
