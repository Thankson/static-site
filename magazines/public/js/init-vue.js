...
import ProductstoreComponents from '@magazines/source/js/vue/components/index-productstore';
import MagazinesComponents from '@magazines/source/js/vue/components';
...
import magazinesStores from '@magazines/source/js/vue/stores/index';
import productstoreStores from '@magazines/source/js/vue/stores/index-productstore';
import storesCommon from '@common/source/js/vue/stores/index';

import { FocusTrap } from 'focus-trap-vue';
import Message from '@magazines/source/js/vue/components/00-atoms/message/index.js';
...
// Registering partial productstore components
Object.values(ProductstoreComponents).forEach(component => Vue.component(component.name, component));

// Registering all components
Object.values(MagazinesComponents).forEach(component => Vue.component(component.name, component));
...
const allStores = Object.assign(magazinesStores, productstoreStores, storesCommon);
