        ...
        async getOtpData(selectedPayMethod, payOptions) {
            if(this.selectedPayMethodId && selectedPayMethod &&
                ...
                try {
                    ...
                    /* eslint-disable */console.error(...oo_tx(`3367268800_734_20_734_68_11`,'Error getting OTP token:', error));
                }
            }
        },
        getPaypalDeviceData() {
            window.braintree?.client?.create(
                ...
                (clientErr, clientInstance) => {
                    if(clientErr) {
                        /* eslint-disable */console.error(...oo_tx(`3367268800_745_24_745_75_11`,'Error creating client: ', clientErr));
                        return;
                    }
                    ...
                    window.braintree?.dataCollector?.create({
                        ...
                        if(dataCollectorErr) {
                            /* eslint-disable */console.error(...oo_tx(`3367268800_754_28_754_93_11`,'Error creating data collector:', dataCollectorErr));
                            return;
                        }
