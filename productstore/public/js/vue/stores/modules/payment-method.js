...
const actions = {
            ...
            await fetch(url, config)
                .then(async response => {
                    ...
                    if(!response.ok) {
                        ...
                        /* eslint-disable */console.log(...oo_oo(`3731065011_439_24_439_80_4`,'pay method saved - before refresh', result));

                        success = await dispatch('handleSuccess', {result, payload, fromCheckout, customerId: isCustomerIdNeededInPayload && customerId});
                    }
                })
                .catch(err => {
                    /* eslint-disable */console.log(...oo_oo(`3731065011_445_20_445_45_4`,'error', err));
                    success = false;
                    fields = [];
                    result = {};
                    const servicesError = translateServicesError(result, errorTranslations, commit);
    ...
    async deletePayMethod({ commit, state }, { payMethodId, customerId }) {
        ...
        if(response.data.Success) {
            /* eslint-disable */console.log(...oo_oo(`3731065011_556_12_556_59_4`,'deleted pay method:', payMethodId));
        } else {
            /* eslint-disable */console.error(...oo_tx(`3731065011_558_12_558_83_11`,'Error trying to delete pay method', response.data.Error));
        }
