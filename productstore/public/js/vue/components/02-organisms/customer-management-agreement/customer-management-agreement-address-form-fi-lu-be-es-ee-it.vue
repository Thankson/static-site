<template>
    <div class="o-customerManagementAgreementAddressFormFiLuBeEsEeIt max-w-contain mx-auto mt-20 py-20 px-10 md:px-40 text-gray-150 text-sm bg-white border-gray-50 border-1">
        ...
        <div class="text-base lg:flex">
            ...
            <div class="md:flex lg:w-1_2">
                <div class="mb-20 md:flex-1 md:mr-15 lg:mx-15">
                    <label
                        class="text-sm font-medium uppercase w" for="postalCode"
                ...
                <div class="mb-20 md:flex-1 md:ml-15"></div>
            </div>
        </div>
        <div class="md:flex">
...
<script>
    ...
    export default {
        name: 'OCustomerManagementAgreementAddressFormFiLuBeEsEeIt',
