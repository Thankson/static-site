    ...
    export default {
        ...
        methods: {
            ...
            async onPaymentSaved({ customerId, payMethodId }) {
                ...
                /* eslint-disable */console.log(...oo_oo(`1852765027_1096_16_1096_86_4`,'pay method saved - after refresh', this.storedPayMethods));
                /* eslint-disable */console.log(...oo_oo(`1852765027_1097_16_1097_85_4`,'selected checkout pay method', this.selectedPayMethodId));
