        ...
        methods: {
            ...
            async cancelOrder(orderNumber) {
                if(orderNumber) {
                    ...
                    if(res.success) {
                        ...
                        /* eslint-disable */console.log(...oo_oo(`1316276692_1180_24_1180_85_4`,'[CancelOrder] inventory response =>', res.error));
                        this.$modal.hide({id: 'cancel-modal'});
                        return false;
                    }
                }
            ...
            isTrackButtonShown(date, OrderStatus, packInfo, orderNumber) {
                try {
                    ...
                    /* eslint-disable */console.log(...oo_oo(`1316276692_1339_20_1339_65_4`,'[pastOrder] isTrackButtonShown'));
                    /* eslint-disable */console.log(...oo_oo(`1316276692_1340_20_1340_34_4`,e));
                }
            },
            printReceipt() {
            ...
            async showProducts() {
                ...
                if(skuQuery.length) {
                    ...
                    if(res.success) {
                        ...
                        /* eslint-disable */console.log(...oo_oo(`1316276692_1462_24_1462_83_4`,'[PastOrder] inventory response =>', res.error));
                        return false;
                    }
                }
            },
