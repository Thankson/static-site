    ...
    <div class="m-payForm">
        ...
        <div v-if="cardOptions && cardOptions.length && isEditing" class="m-payForm__row">
            <div class="m-formField -text" :class="{'m-payForm__field': isEditing}">
                ...
                <input-basic-pseudo
                    :value="getLabels('Labels.Header.Debit', cardType.Value)">
                </input-basic-pseudo>
            </div>
        </div>
        ...
        <div class="m-payForm__cards -isCn">{{ getLabels('Labels.Card.DebitAccepts', cardTitle) }}</div>
    </div>
</template>
