<template>
    <div
        v-if="labels"
        class="o-customerManagementAgreementPersonalInfo max-w-contain mx-auto py-20 px-10 md:px-40 text-dark text-sm bg-white border-gray-50 border-1"
    >
        ...
        <div class="flex flex-col text-base">
            ...
            <div class="flex flex-col md:flex-row justify-between">
                <div class="flex flex-col md:flex-row md:w-1_2 py-10">
                    ...
                    <div v-if="labels.Password" class="flex-1 md:mr-15">
                        <label
                            class="uppercase text-sm font-medium whitespace-no-wrap"
                            for="password"
                            v-html="
            ...
            <div class="flex flex-col md:flex-row justify-between">
                <!-- Second Last Name -->
                <div
                    v-if="labels.MaternalSurname"
                    class="flex-1 md:mr-15 py-10"
                >
                    <label
                        class="uppercase text-sm font-medium"
                        :for="secondLastName"
                    ...
                    <v-input
                        ...
                        :value="prospectiveCustomerData.SecondLastName"
                        max-length="100"
                        aria-required="false"
                        @input="setValue('secondLastName', $event)"
                    />
                </div>
                <!-- Phone Fields -->
            ...
            <div class="flex flex-col md:flex-row justify-between">
                <div class="flex flex-1 md:mr-15 py-10">
                    <!-- Customer Type -->
                    <div
                        v-if="labels.ValidCustomerTypes"
                        class="flex-1 mr-5 md:mr-15"
                    >
                        <label
                            class="uppercase text-sm font-medium"
                            for="phonetype"
                    ...
                    <!-- Email Input -->
                    <div v-if="labels.Email" class="flex-1 ml-5 md:ml-15">
                        <label
                            class="uppercase text-sm font-medium"
                            :for="email.id"
                            v-html="
