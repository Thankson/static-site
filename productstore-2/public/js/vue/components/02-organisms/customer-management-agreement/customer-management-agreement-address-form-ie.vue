<template>
    <div class="o-customerManagementAgreementAddressFormIe max-w-contain mx-auto mt-20 py-20 px-10 md:px-40 text-gray-150 text-sm bg-white border-gray-50 border-1">
...
<script>
    ...
    export default {
        name: 'OCustomerManagementAgreementAddressFormIe',
