...
(() => {
    ...
    try {
        ...
        /* eslint-disable */console.log(...oo_oo(`472348047_82_8_82_94_4`,TAG, 'Vue build check - Has compiler:', typeof Vue.compile === 'function'));
        if(typeof Vue.compile === 'function') {
            /* eslint-disable */console.error(...oo_tx(`472348047_84_12_84_106_11`,TAG, '⚠️ WARNING: PCI bundle has Vue compiler! This will cause CSP violations!'));
        } else {
            /* eslint-disable */console.log(...oo_oo(`472348047_86_12_86_72_4`,TAG, '✅ Using runtime-only Vue (CSP compliant)'));
        }
        ...
        (function upgradeVueComponentTags() {
            ...
            componentMappings.forEach(({ selector, possibleNames }) => {
                ...
                /* eslint-disable */console.log(...oo_oo(`472348047_248_16_248_82_4`,TAG_LOCAL, `found ${nodes.length} <${selector}> tags`));

                const registeredName = findRegisteredName(possibleNames);

                if(!registeredName) {
                    /* eslint-disable */console.error(...oo_tx(`472348047_253_20_253_140_11`,TAG_LOCAL, `component not registered for selector: ${selector}. Tried names: ${possibleNames.join(', ')}`));
                    return;
                }
                ...
                nodes.forEach((el) => {
                    try {
                        ...
                        if(process.env.NODE_ENV === 'development') {
                            /* eslint-disable */console.log(...oo_oo(`472348047_289_28_289_96_4`,TAG_LOCAL, `converted <${selector}> with props:`, props));
                        }
                    } catch (error) {
                        /* eslint-disable */console.error(...oo_tx(`472348047_292_24_292_98_11`,TAG_LOCAL, `error converting element <${selector}>:`, error));
                    }
                });
            });

            if(totalConverted > 0) {
                /* eslint-disable */console.log(...oo_oo(`472348047_298_16_298_86_4`,TAG_LOCAL, `converted ${totalConverted} total components`));
            }
        }());
        ...
        const mountIslands = () => {
            ...
            /* eslint-disable */console.log(...oo_oo(`472348047_305_12_305_100_4`,TAG, 'islands found:', nodes.map(n => n.getAttribute('data-vue-component'))));
            ...
            nodes.forEach((el) => {
                ...
                let props = {};
                try { props = JSON.parse(raw); } catch (e) { /* eslint-disable */console.error(...oo_tx(`472348047_313_61_313_117_11`,TAG, 'bad JSON in data-vue-props', e, raw)); }
                ...
                if(!Ctor) {
                    /* eslint-disable */console.error(...oo_tx(`472348047_320_20_320_73_11`,TAG, 'component not registered:', name));
                    return;
                }
        ...
        // ---- Boot ----
        /* eslint-disable */console.log(...oo_oo(`472348047_347_8_347_32_4`,TAG, 'boot'));
        ...
        /* eslint-disable */console.error(...oo_tx(`472348047_362_8_362_38_11`,TAG, 'fatal', e));
    }
})();
